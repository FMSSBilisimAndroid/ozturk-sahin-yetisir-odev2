...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginImageButton.setOnClickListener {
            ...
            /**
             * if username & passwords match with userdata.xml login is successful and open LastIntent activity.
             * else if loginUsername variables are empty creates toast message " username & password cannot be left blank "
             * else if username or password empty at first time and userdata.xml not created yet get toast message " Go Register Page "
